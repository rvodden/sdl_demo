...
int main() {
  ...
  std::cout << "TestEvent1 instance 1 code: " << event1a.getEventType()
            << std::endl;
  std::cout << "TestEvent1 instance 2 code: " << event1b.getEventType()
            << std::endl;
  std::cout << "TestEvent1 instance 3 code: " << event1c.getEventType()
            << std::endl;
  ...
  std::cout << "TestEvent2 instance 1 code: " << event2a.getEventType()
            << std::endl;
  std::cout << "TestEvent2 instance 2 code: " << event2b.getEventType()
            << std::endl;
  std::cout << "TestEvent2 static code: " << TestEvent2::getEventType()
            << std::endl;

  bool test2_passed =
      (event2a.getEventType() == event2b.getEventType() &&
  ...
  std::cout << "Test 1 (Same type, same code): "
            << (test1_passed ? "PASSED" : "FAILED") << std::endl;
  std::cout << "Test 2 (Different types, different codes): "
            << (test2_passed ? "PASSED" : "FAILED") << std::endl;
  std::cout << "Test 3 (Sequential allocation): "
            << (test3_passed ? "PASSED" : "FAILED") << std::endl;
