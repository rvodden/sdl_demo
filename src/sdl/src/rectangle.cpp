...
FloatRectangle::FloatRectangle(FloatRectangle &&other) noexcept : _rectangleImpl{ std::move(other._rectangleImpl) } {}
...
auto FloatRectangle::operator=(FloatRectangle &&other) noexcept -> FloatRectangle& {
