...
/**
 * @brief Exception thrown when an unknown or unsupported event type is encountered
 * 
 * This exception is thrown when the event system encounters an event type that
 * it doesn't know how to handle or process.
 */
 ...
 * for when the event occurred. Most concrete event types inherit from this class.
 */
 ...
 * (like SDL, user input, timers, etc.) and providing them to the event system.
 */
