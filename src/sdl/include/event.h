 ...
 * from platform-specific event types to sdl event objects. Each platform
...
class EventAdaptor {
 public:
  /**
   * @brief Convert platform event to sdl event
   * @param event The platform-specific event to convert
   * @return Converted sdl event, or nullptr if conversion not possible
   */
