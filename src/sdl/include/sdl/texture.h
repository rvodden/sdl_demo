 ...
 * 
 * // Load from file
 * sdl::Texture sprite(renderer, "player.png");
 * 
 * // Configure blending
 * sprite.setTextureBlendMode(sdl::Texture::kBlend);
 * 
 * // Draw to screen
...
class SDL_EXPORT Texture {
 ...
 public:
   ...
   * @throws sdl::Exception if file loading or texture creation fails
   *
   ...
   * @throws sdl::Exception if data parsing or texture creation fails
   *
   ...
   * @throws sdl::Exception if texture creation fails
   *
