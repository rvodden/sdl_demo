 ...
 * surface.setPixel(128, 128, sdl::NamedColor::kWhite);
 * 
...
class SDL_EXPORT Surface {
 ...
 public:
   ...
   * @throws sdl::Exception if file loading fails or format is unsupported
   *
   ...
   * @throws sdl::Exception if surface creation fails or dimensions are invalid
   *
   ...
   * @throws sdl::Exception if data size doesn't match dimensions or surface creation fails
   *
   ...
   * @throws sdl::Exception if data size doesn't match surface dimensions
   *
   ...
   * @throws sdl::Exception if coordinates are outside the surface bounds
   *
   ...
   * @throws sdl::Exception if the rectangle extends outside the surface bounds
   *
   ...
   * @throws sdl::Exception if the operation would extend outside surface bounds
   *
   ...
   * @throws sdl::Exception if source or destination rectangles are invalid
   *
   ...
   * @throws sdl::Exception if file writing fails or format is unsupported
   *
