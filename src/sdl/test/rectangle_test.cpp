...
TEST(RectangleAliasTest, TypeAliases) {
    static_assert(std::is_same_v<sdl::IntRectangle, sdl::Rectangle<int32_t>>);
    static_assert(std::is_same_v<sdl::FloatRectangle, sdl::Rectangle<float>>);
    
    sdl::IntRectangle intRect(1, 2, 3, 4);
    sdl::FloatRectangle floatRect(1.5f, 2.5f, 3.5f, 4.5f);
...
TEST(RectangleConceptTest, ValidTypes) {
    ...
    static_assert(sdl::RectangleCoordinate<int32_t>);
    static_assert(sdl::RectangleCoordinate<float>);
    
    // Test that these types can be used to create rectangles
    sdl::Rectangle<int32_t> intRect(10, 20, 100, 200);
    sdl::Rectangle<float> floatRect(10.5f, 20.5f, 100.5f, 200.5f);
...
TEST(RectangleConceptTest, InvalidTypes) {
    ...
    static_assert(!sdl::RectangleCoordinate<uint32_t>);
    static_assert(!sdl::RectangleCoordinate<double>);
    static_assert(!sdl::RectangleCoordinate<int16_t>);
    static_assert(!sdl::RectangleCoordinate<uint16_t>);
    static_assert(!sdl::RectangleCoordinate<int8_t>);
    static_assert(!sdl::RectangleCoordinate<uint8_t>);
    static_assert(!sdl::RectangleCoordinate<char>);
    static_assert(!sdl::RectangleCoordinate<std::string>);
    static_assert(!sdl::RectangleCoordinate<void*>);
}
