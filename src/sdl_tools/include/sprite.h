 ...
 * region using a sdl::Rectangle<float>, allowing for pixel-perfect extraction
 ...
 * @see sdl::Rectangle<float> for the sprite region definition
 *
 * Example usage:
 * @code
 ...
 * sdl::tools::Sprite playerIdle(sharedTexture, sdl::Rectangle<float>(0, 0, 32, 48));
 * sdl::tools::Sprite playerWalk1(sharedTexture, sdl::Rectangle<float>(32, 0, 32, 48));
 * sdl::tools::Sprite playerWalk2(sharedTexture, sdl::Rectangle<float>(64, 0, 32, 48));
 * 
...
class SDL_TOOLS_EXPORT Sprite {
 ...
 public:
   ...
   * @throws sdl::Exception if sprite creation fails or texture is invalid
   *
