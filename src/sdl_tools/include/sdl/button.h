 ...
 * @see sdl::Rectangle<float> for the clickable area definition
 *
 * Example usage:
 * @code
 ...
 * sdl::Rectangle<float> bounds(100.0f, 50.0f, 200.0f, 75.0f);
...
class SDL_TOOLS_EXPORT Button {
 public:
   ...
   * @throws sdl::Exception if button registration with the event router fails
   *
