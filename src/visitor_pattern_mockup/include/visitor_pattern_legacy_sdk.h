...
class BaseEventHandler { 
  public:
    ...
    auto operator=(const BaseEventHandler& baseEventHandler) -> BaseEventHandler& = default;
    auto operator=(BaseEventHandler&& baseEventHandler) noexcept -> BaseEventHandler& = default;
...
class InternalEventHandler {
  public:
    ...
    InternalEventHandler(InternalEventHandler&& baseEventHandler) noexcept = default;

    auto operator=(const InternalEventHandler& baseEventHandler) -> InternalEventHandler& = default;
    auto operator=(InternalEventHandler&& baseEventHandler) noexcept -> InternalEventHandler& = default;

    virtual ~InternalEventHandler() noexcept = default;
    
    virtual void handle(__attribute_maybe_unused__ const EventClass& event) const {};
};
